        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Install mairouter, configure your providers via web dashboard, and
            ...
            <div className="flex flex-col gap-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-lg">Install mairouter</h4>
            ...
            <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-[#3a2f27] shadow-2xl">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                <div
                  ...
                  onClick={() => handleCopy("npx mairouter")}
                >
                  <span className="text-green-400">$</span>
                  <span className="text-white">npx mairouter</span>
                ...
                <div className="text-gray-400 text-xs">
                  ...
                  ~/.mairouter/db/data.sqlite
                  <br />
                  <span className="text-gray-500"> Windows:</span>{" "}
                  %APPDATA%/mairouter/db/data.sqlite
                </div>
              </div>
            </div>
          </div>
