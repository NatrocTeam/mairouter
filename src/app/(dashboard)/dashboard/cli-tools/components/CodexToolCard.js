...
export default function CodexToolCard({
  ...
  const handleApplySettings = async () => {
    ...
    setMessage(null);
    try {
      // Use sk_mairouter for localhost if no key, otherwise use selected key
      const keyToUse =
  ...
  const getManualConfigs = () => {
    ...
    const configContent = `# mairouter Configuration for Codex CLI
model = "${selectedModel}"
model_provider = "mairouter"

[model_providers.mairouter]
name = "mairouter"
