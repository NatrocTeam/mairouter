...
// Build TOML config for mairouter (openai provider mode)
const buildmairouterConfig = (baseUrl, apiKey, model) => {
...
// Detect mairouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
  try {
    ...
    const newConfig = buildmairouterConfig(
      baseUrl,
      apiKey || "sk_mairouter",
      model,
    );
