...
export const CLI_TOOLS = {
  ...
  amp: {
    ...
    notes: [
      {
        type: "info",
        text: "Use mairouter model aliases to keep Amp shorthand mappings stable across provider updates.",
      },
      {
        type: "warning",
    ...
    guideSteps: [
      ...
      { step: 4, title: "Select Model", type: "modelSelector" },
      {
        ...
        desc: "Map Amp shorthand names such as g25p or cs45 to mairouter aliases in your local config.",
      },
    ],
    codeBlock: {
      language: "bash",
...
# cs45 -> cc/claude-sonnet-4-5-20250929`,
  ...
  qwen: {
    ...
    color: "#10B981",
    description:
      "Alibaba Qwen Code CLI — supports OpenAI, Anthropic & Gemini providers via mairouter",
    docsUrl:
    ...
    notes: [
      {
        type: "info",
        text: "Qwen Code supports multiple provider types (openai, anthropic, gemini) via modelProviders in settings.json. mairouter works as an OpenAI-compatible endpoint.",
      },
      {
        type: "info",
        text: "Any model available in mairouter can be used — not just Qwen models. Select from Qwen, Claude, Gemini, GPT, and more.",
      },
      {
        type: "warning",
      ...
      {
        type: "error",
        text: "Qwen OAuth free tier was discontinued on 2026-04-15. Use mairouter with alicode/openrouter/anthropic/gemini providers instead.",
      },
    ],
    modelAliases: [
      "coder-model",
  ...
  "deepseek-tui": {
    ...
    notes: [
      {
        type: "info",
        text: "DeepSeek TUI uses ~/.deepseek/config.toml for configuration. mairouter will update the provider to 'openai' mode with your base_url, api_key, and model.",
      },
      {
        type: "warning",
  ...
  jcode: {
    ...
    notes: [
      ...
      {
        type: "info",
        text: "Configure mairouter as an OpenAI-compatible provider to route all jcode requests through mairouter's optimization layer.",
      },
      {
        type: "warning",
