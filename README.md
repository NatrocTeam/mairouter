...
🎉 Dashboard opens at `http://localhost:12890`
...
- Dashboard: `http://localhost:12890/dashboard`
- OpenAI-compatible API: `http://localhost:12890/v1`
...
docker run -d --name 9router -p 12890:12890 \
...
| `PORT`                                               | framework default                        | Service port (`12890` in examples)                                                  |
| `HOSTNAME`                                           | framework default                        | Bind host (Docker defaults to `0.0.0.0`)                                            |
| `NODE_ENV`                                           | runtime default                          | Set `production` for deploy                                                         |
| `BASE_URL`                                           | `http://localhost:12890`                 | Server-side internal base URL used by cloud sync jobs                               |
...
- Set `PORT=12890` and `NEXT_PUBLIC_BASE_URL=http://localhost:12890`
